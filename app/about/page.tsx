    ...
    <div className="pt-20 pb-0 bg-light min-h-screen">
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
            ...
            <p className="text-primary-dark opacity-80 mb-4">
              Bij T&R Car Detail bieden we een totaalpakket aan professionele auto detailing diensten. Steeds met het doel om jouw wagen terug in absolute showroomstaat te brengen!
            </p>
            <p className="text-primary-dark opacity-80 mb-4">
              Door gebruik te maken van de beste materialen, producten en technieken kunnen wij het allerbeste resultaat behalen.
            </p>
          </motion.div>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16">
          ...
          <p className="text-primary-dark opacity-80 text-center max-w-2xl mx-auto mb-12">Twee jonge, gemotiveerde specialisten die uw auto met passie behandelen</p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-3xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.1 }}>
              <Card hover className="text-center overflow-hidden">
                ...
                <p className="text-primary-dark opacity-70 text-sm mt-2">Specialist in exterieurreiniging, lakbescherming en showroomglans</p>
              </Card>
            </motion.div>
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: 0.2 }}>
              <Card hover className="text-center overflow-hidden">
                ...
                <p className="text-primary-dark opacity-70 text-sm mt-2">Specialist in interieurreiniging, stoffering en dieptereiniging</p>
              </Card>
            </motion.div>
          </div>
        </motion.div>
