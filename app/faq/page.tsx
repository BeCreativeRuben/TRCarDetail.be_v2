...
const faqs: FAQItem[] = [
  { question: 'Hoe lang duurt een wasbeurt?', answer: 'Een premium handwash duurt gemiddeld 2-3 uur, afhankelijk van de grootte en staat van uw voertuig. Een complete behandeling met interieur kan 4-6 uur duren.' },
  { question: 'Moet ik een afspraak maken?', answer: 'Ja, we werken uitsluitend op afspraak om u de beste service te kunnen bieden. U kunt online een afspraak boeken of contact met ons opnemen.' },
  { question: 'Wat is het verschil tussen een gewone wasbeurt en een premium handwash?', answer: 'Een premium handwash gebruikt de 2-emmer methode om krassen te voorkomen, professionele producten, en extra aandacht voor details zoals deurstijlen, wielkasten en bandendressing.' },
  ...
  { question: 'Wat als mijn auto in slechte staat is?', answer: 'Geen probleem! We behandelen auto\'s in alle condities. Voor auto\'s die extra aandacht nodig hebben, kunnen we een programma op maat samenstellen.' },
  {
    ...
    answer:
      'Wij zijn vrijgesteld van btw (artikel 44). De getoonde prijzen zijn het bedrag dat u betaalt; er komt geen btw bij. Kleine onderneming onderworpen aan de vrijstellingsregeling van belasting — btw niet toepasselijk. Prijzen zijn indicatief en kunnen variëren naargelang grootte, staat en complexiteit van uw voertuig.',
  },
]
